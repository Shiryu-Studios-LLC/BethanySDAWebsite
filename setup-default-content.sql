-- Complete professional church website content setup
-- Based on Houston SDA reference site
...
UPDATE pages SET content = '[
  ...
  },
  {
    ...
    "type": "text",
    "content": {
      "html": "<h2 style=\"text-align: center; margin-bottom: 1rem;\">Welcome Home</h2><p style=\"text-align: center; font-size: 1.1rem; color: #666;\">Whether you are a long-time member or visiting for the first time, we are glad you are here. At Bethany SDA Church, you will find a warm, welcoming community dedicated to growing in faith together.</p>"
    }
  },
  {
    "id": "block-services",
          ...
          "blocks": [
            {
              ...
              "content": {
                ...
                "description": "Interactive Bible study and fellowship",
                "linkText": "Learn More",
          ...
          "blocks": [
            {
              ...
              "content": {
                ...
                "description": "Uplifting praise and inspiring messages",
                "linkText": "Learn More",
          ...
          "blocks": [
            {
              ...
              "type": "text",
              "content": {
                "html": "<h3>Youth Ministry</h3><p>Engaging programs for young people to grow in faith, build friendships, and serve their community.</p>"
              }
            }
          ]
        },
...
UPDATE pages SET content = '[
  {
    ...
    "type": "hero",
    "content": {
      "title": "About Bethany SDA Church",
      "subtitle": "Houston'\''s Haitian Seventh-day Adventist Community",
      "buttonText": "",
      "buttonUrl": "",
      "backgroundType": "color",
  ...
  },
  {
    ...
    "type": "text",
    "content": {
      "html": "<h2>Our Ministries</h2><p>We offer various ministries to serve our congregation and community:</p>"
    }
  },
  {
      ...
      "items": [
        {
          ...
          "description": "Programs to strengthen marriages and families"
        },
        {
          "icon": "👶",
          "title": "Children'\''s Ministry",
          "description": "Sabbath School and programs for kids of all ages"
        },
        {
          "icon": "🎓",
          "title": "Youth Ministry",
          "description": "Pathfinders, Adventurers, and teen activities"
        },
        {
          "icon": "🍲",
          "title": "Community Services",
          "description": "Food pantry and outreach programs"
        },
        {
          "icon": "💪",
          "title": "Health Ministry",
          "description": "Cooking classes and health screenings"
        },
        {
          "icon": "🌍",
...
UPDATE pages SET content = '[
  {
    ...
    "content": {
      ...
      "subtitle": "We would love to meet you! Here'\''s everything you need to know.",
      "buttonText": "",
      "buttonUrl": "",
      "backgroundType": "color",
      "backgroundColor": "#0054a6"
  ...
  },
  {
    ...
    "type": "text",
    "content": {
      "html": "<h2>Location & Directions</h2><p><strong>Bethany SDA Church</strong><br>Houston, Texas<br><em>(Address to be added)</em></p><p>Free parking is available in our parking lot. Handicap accessible parking spots are located near the main entrance.</p>"
    }
  },
  {
    "id": "visit-first-time",
    ...
    "content": {
      ...
      "message": "Look for our greeters at the entrance - they'\''ll help you find your way and answer any questions. We have a Welcome Center where you can get more information about our church.",
      "style": "success"
    }
  },
  {
          ...
          "blocks": [
            {
              ...
              "content": {
                ...
                "description": "Age-appropriate Sabbath School classes from cradle roll through teens",
                "linkText": "",
                "linkUrl": ""
              }
            }
          ...
          "blocks": [
            {
              ...
              "content": {
                "icon": "🚗",
                "title": "Parking",
                "description": "Free parking with handicap accessible spots near the entrance",
                "linkText": "",
                "linkUrl": ""
              }
            }
          ...
          "blocks": [
            {
              ...
              "content": {
                "icon": "♿",
                "title": "Accessibility",
                "description": "Wheelchair accessible facilities and elevators available",
                "linkText": "",
                "linkUrl": ""
              }
            }
  ...
  },
  {
    ...
    "type": "text",
    "content": {
      "html": "<h2 style=\"text-align: center;\">Questions?</h2><p style=\"text-align: center;\">If you have any questions before your visit, please don'\''t hesitate to reach out. We'\''re here to help!</p><div style=\"text-align: center; margin-top: 1.5rem;\"><a href=\"/contact\" class=\"btn btn-primary btn-lg\">Contact Us</a></div>"
    }
  }
]' WHERE slug = 'visit';
